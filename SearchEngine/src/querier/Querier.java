...
public class Querier {
    ...
    public Querier(final Set<Document> documents) {
    ...
    private PriorityQueue<DocumentSimilarity> findTopDocumentSimilarities(final Document query, final int numResults) {
        ...
        for (final Document document : documents) {
            //careful this order is correct
            final DocumentSimilarity documentSimilarity = new DocumentSimilarity(query, document);
    ...
    private class DocumentSimilarity {
        ...
        public DocumentSimilarity(final Document queryDocument, final Document document) {
            this.queryDocument = queryDocument;
            this.document = document;
            this.similarity = queryDocument.calculateSimilarity(document);
        }
